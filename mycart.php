...
<head>
  ...
  <title>Pooja Store | My Cart</title>
...
<body>
    <header>
      ...
      <h1 class="overlay-text ml-1 text-center animated zoomIn">Excel your shopping cart</h1>
    </header>
    <div class="content">
    ...
    if($total>0){
    ?>
    <a href="checkout.php" class="btn btn-success text-white p-3 mr-4">Checkout</a>
    <?php
    }else{
    ?>
